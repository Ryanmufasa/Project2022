...
public class MemberDAO {
	...
	public Vector getComment(String mem_id) throws ClassNotFoundException, SQLException {
		Vector data = new Vector();
		JavaoraMemVO memberVO = new JavaoraMemVO();

        conn = new JavaoraDBConn().getConnection();
        try {
        	pstmt = conn.prepareStatement("select * from comments where mem_id = ?");
        	pstmt.setString(1, mem_id);
	...
	public int update(JavaoraMemVO memberVO) 
